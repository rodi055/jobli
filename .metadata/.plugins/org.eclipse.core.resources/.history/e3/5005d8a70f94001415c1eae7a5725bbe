...
public abstract class BaseLoginActivity extends FragmentActivity implements
	...
	public void onConnected(Bundle arg0) {
		...
		com.R.L.A.jobli.UserManager.INSTANCE.loginUser(u, new UiOnDone() {
	...
	private User getProfileInformation() {
		...
		try {
			if (Plus.PeopleApi.getCurrentPerson(mGoogleApiClient) != null) {
				...
				u = new User(0L, currentPerson.getId(), personPhotoUrl,
						personName);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		// progressDialog.setMessage(this.getResources().getString(
		// R.string.revoke_access_msg));
		// progressDialog.show();
		// ServerRequestManager.INSTANCE.removeUser(
		// UserManager.INSTANCE.getMyData(), new UiOnDone() {
		// @Override
		// public void execute() {
		// revokeGplusAccess();
		// UserManager.INSTANCE.logout();
