 ...
 * on 2015-01-06 at 17:04:12 UTC 
 * Modify at your own risk.
 */

package com.rla.userendpoint;
...
public class Userendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://strange-reducer-801.appspot.com/_ah/api/";
  ...
  public class GetUser extends UserendpointRequest<com.rla.userendpoint.model.User> {
    ...
    protected GetUser(java.lang.Long id) {
      super(Userendpoint.this, "GET", REST_PATH, null, com.rla.userendpoint.model.User.class);
  ...
  /**
   * Create a request for the method "insertGPUser".
   *
   * This request holds the parameters needed by the userendpoint server.  After setting any optional
   * parameters, call the {@link InsertGPUser#execute()} method to invoke the remote operation.
   *
   * @param content the {@link com.rla.userendpoint.model.User}
   * @return the request
   */
  public InsertGPUser insertGPUser(com.rla.userendpoint.model.User content) throws java.io.IOException {
    InsertGPUser result = new InsertGPUser(content);
    initialize(result);
    return result;
  }

  public class InsertGPUser extends UserendpointRequest<com.rla.userendpoint.model.User> {
     ...
     *
     * This request holds the parameters needed by the the userendpoint server.  After setting any
     * optional parameters, call the {@link InsertGPUser#execute()} method to invoke the remote
     * operation. <p> {@link
     * InsertGPUser#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
     * must be called to initialize this instance immediately after invoking the constructor. </p>
     *
     * @param content the {@link com.rla.userendpoint.model.User}
     * @since 1.13
     */
    protected InsertGPUser(com.rla.userendpoint.model.User content) {
      super(Userendpoint.this, "POST", REST_PATH, content, com.rla.userendpoint.model.User.class);
    }

    @Override
    public InsertGPUser setAlt(java.lang.String alt) {
      return (InsertGPUser) super.setAlt(alt);
    }

    @Override
    public InsertGPUser setFields(java.lang.String fields) {
      return (InsertGPUser) super.setFields(fields);
    }

    @Override
    public InsertGPUser setKey(java.lang.String key) {
      return (InsertGPUser) super.setKey(key);
    }

    @Override
    public InsertGPUser setOauthToken(java.lang.String oauthToken) {
      return (InsertGPUser) super.setOauthToken(oauthToken);
    }

    @Override
    public InsertGPUser setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (InsertGPUser) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public InsertGPUser setQuotaUser(java.lang.String quotaUser) {
      return (InsertGPUser) super.setQuotaUser(quotaUser);
    }

    @Override
    public InsertGPUser setUserIp(java.lang.String userIp) {
      return (InsertGPUser) super.setUserIp(userIp);
    }

    @Override
    public InsertGPUser set(String parameterName, Object value) {
      return (InsertGPUser) super.set(parameterName, value);
    }
  }
   ...
   * @return the request
   */
  public InsertUser insertUser(com.rla.userendpoint.model.User content) throws java.io.IOException {
    InsertUser result = new InsertUser(content);
    initialize(result);
    return result;
  }

  public class InsertUser extends UserendpointRequest<com.rla.userendpoint.model.User> {
     ...
     * @since 1.13
     */
    protected InsertUser(com.rla.userendpoint.model.User content) {
      super(Userendpoint.this, "POST", REST_PATH, content, com.rla.userendpoint.model.User.class);
    }
  ...
  public class ListUser extends UserendpointRequest<com.rla.userendpoint.model.CollectionResponseUser> {
     ...
     */
    protected ListUser() {
      super(Userendpoint.this, "GET", REST_PATH, null, com.rla.userendpoint.model.CollectionResponseUser.class);
    }
   ...
   * @return the request
   */
  public UpdateUser updateUser(com.rla.userendpoint.model.User content) throws java.io.IOException {
    UpdateUser result = new UpdateUser(content);
    initialize(result);
    return result;
  }

  public class UpdateUser extends UserendpointRequest<com.rla.userendpoint.model.User> {
     ...
     * @since 1.13
     */
    protected UpdateUser(com.rla.userendpoint.model.User content) {
      super(Userendpoint.this, "PUT", REST_PATH, content, com.rla.userendpoint.model.User.class);
    }
